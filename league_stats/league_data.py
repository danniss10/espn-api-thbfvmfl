"""Shared module for fetching ESPN fantasy football league data."""
...
def get_all_scores(start_year: int, end_year: int) -> list:
    """Fetch all single-week scores across all seasons."""
    all_games = []

    if start_year < 2019:
        all_games.extend(get_pre_2019_scores(start_year))

    all_games.extend(get_2019_plus_scores(end_year))
